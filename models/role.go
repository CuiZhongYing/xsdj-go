...
type Role struct {
	...
	RoleName   string `orm:"column(role_name);size(255);null" description:"权限名"`
	Permission int    `orm:"column(permission);null" description:"权限值"`
	Manager []*Manager `orm:"reverse(many)"`
}
